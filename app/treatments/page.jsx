          ...
          >
            ...
            <div className='grid grid-cols-1 md:grid-cols-2 gap-[20px] mb-14 mx-auto xl:mx-0'>
              ...
              <div className='flex-1 flex flex-col justify-center items-center xl:items-start'>
                ...
                <p className='pl-6 tex-[15px]'>
                  Sculpts the eyebrows and removes unwanted hair using wax for a defined, pleasing contour.
                </p>
              </div>
              {/* end item */}
              {/* item */}
              <div className='flex-1 flex flex-col justify-center items-center xl:items-start'>
                ...
                <p className='pl-6 tex-[15px]'>
                  Multi-step treatment for instant hydration grow
                </p>
              </div>
              {/* end item */}
            </div>
